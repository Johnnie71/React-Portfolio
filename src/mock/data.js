...
export const aboutData = {
  ...
  paragraphTwo:
    'With a background in architectural design my passion for sustainability has driven me to programming. In todays climate I feel it is important to lead by example and help accelerate the push towards green energy. Helping others around the world access such vital information through tech.',
  paragraphThree:
